  ...
  return (
    <div className="space-y-3 py-2">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="default">
                {translate(
                  'auto.components.settings.AppearanceInterfaceSection.defaultTheme',
                  'Default'
                )}
              </SelectItem>
      ...
      <AppearanceAdvancedDisclosure
        label={translate(
          'auto.components.settings.AppearanceInterfaceSection.customThemesList',
          'Custom Themes'
        )}
        showTopBorder={false}
        className="mt-1 pt-0"
      ...
      >
            ...
            {settings.customUiThemes.map((t) => (
              ...
              >
                ...
                <Button
                  ...
                  title={translate(
                    'auto.components.settings.AppearanceInterfaceSection.deleteTheme',
                    'Delete theme'
                  )}
                >
        ...
        >
          <h4 className="text-xs font-semibold">
            {translate(
              'auto.components.settings.AppearanceInterfaceSection.importTheme',
              'Import Theme'
            )}
          </h4>
          <div className="flex gap-2">
            <Input
              ...
              placeholder={translate(
                'auto.components.settings.AppearanceInterfaceSection.themeNamePlaceholder',
            ...
            <Button
              ...
              onClick={() => {
                const fallbackName = translate(
                  'auto.components.settings.AppearanceInterfaceSection.fallbackThemeName',
                  'Custom Theme'
                )
                ...
                if (importedThemes.length === 0) {
                  setImportError(
                    translate(
                      'auto.components.settings.AppearanceInterfaceSection.importErrorDescription',
            ...
            >
              {translate(
                'auto.components.settings.AppearanceInterfaceSection.importButton',
                'Import'
              )}
            </Button>
          </div>
          ...
          <Textarea
            ref={cssRef}
            placeholder={translate(
              'auto.components.settings.AppearanceInterfaceSection.textareaPlaceholder',
